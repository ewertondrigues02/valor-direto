...
/** @type {__VLS_StyleScopedClasses['checkbox-group']} */ ;
/** @type {__VLS_StyleScopedClasses['custom-checkbox-label']} */ ;
/** @type {__VLS_StyleScopedClasses['custom-checkbox']} */ ;
/** @type {__VLS_StyleScopedClasses['checkbox-group']} */ ;
/** @type {__VLS_StyleScopedClasses['custom-checkbox-label']} */ ;
/** @type {__VLS_StyleScopedClasses['custom-checkbox']} */ ;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "input-group checkbox-group" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    id: "adicional",
    type: "checkbox",
});
(__VLS_ctx.incluirAdicional);
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ for: "adicional" }, { class: "custom-checkbox-label" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "custom-checkbox" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "checkbox-text" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.small, __VLS_intrinsicElements.small)({});
